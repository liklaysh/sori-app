...
SORI App проверяет новые версии через GitHub Releases. Если обновление доступно, приложение показывает уведомление и предлагает установить его сейчас или позже.

Обновления устанавливаются поверх текущей версии, пользовательские данные не удаляются. На раннем этапе macOS или Windows могут показывать предупреждение, потому что тестовые сборки пока не подписаны платными сертификатами ОС.
